...
export default class AccordionUI {
  constructor() {
    this.$accordionWraps = Array.from(document.querySelectorAll(".js-accordion-wrap"));
    this.$accordionInners = Array.from(document.querySelectorAll(".js-accordion-inner"));
    this.openAccordionButtons = Array.from(document.querySelectorAll(".js-accordion"));
